# AUTOGENERATED!!! Date: 2026-05-16 06:47:20.049520+00:00\n
...
code_to_name_doc: dict[int, tuple[str, str]] = {
    ...
    0x40F20000: ('UncertainOverRange', 'The value is over the allowed range.'),
    0x40F30000: ('UncertainUnderRange', 'The value is under the allowed range.'),
    ...
    0x80520000: ('BadSemaphoreFileMissing', 'The semaphore file specified by the client is not valid.'),
    ...
    0x80F10000: ('BadTransactionFailed', 'The operation failed and all changes which were part of the transaction are rolled back.'),
