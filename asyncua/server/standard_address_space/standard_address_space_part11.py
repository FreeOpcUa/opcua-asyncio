...
async def create_standard_address_space_Part11(server):
    ...
    attrs.Value = [LocalizedText(text='AbsoluteValue', locale=None), LocalizedText(text='PercentOfValue', locale=None), LocalizedText(text='PercentOfRange', locale=None), LocalizedText(text='PercentOfEURange', locale=None), LocalizedText(text='Unknown', locale=None)]
    attrs.ValueRank = 1
    node.NodeAttributes = attrs
    await server.add_nodes([node])
    refs = []
