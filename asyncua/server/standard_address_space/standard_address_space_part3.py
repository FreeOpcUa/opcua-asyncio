...
async def create_standard_address_space_Part3(server):
    ...
    attrs.DisplayName = LocalizedText("EnumStrings")
    attrs.DataType = ua.NodeId(ua.ObjectIds.LocalizedText)
    attrs.Value = [LocalizedText(text= 'Numeric', locale= None),LocalizedText(text= 'String', locale= None),LocalizedText(text= 'Guid', locale= None),LocalizedText(text= 'Opaque', locale= None)]
    attrs.ValueRank = 1
    node.NodeAttributes = attrs
    await server.add_nodes([node])
    refs = []
    ...
    attrs.DisplayName = LocalizedText("OptionSetValues")
    attrs.DataType = ua.NodeId(ua.ObjectIds.LocalizedText)
    attrs.Value = [LocalizedText(text= 'Browse', locale= None),LocalizedText(text= 'ReadRolePermissions', locale= None),LocalizedText(text= 'WriteAttribute', locale= None),LocalizedText(text= 'WriteRolePermissions', locale= None),LocalizedText(text= 'WriteHistorizing', locale= None),LocalizedText(text= 'Read', locale= None),LocalizedText(text= 'Write', locale= None),LocalizedText(text= 'ReadHistory', locale= None),LocalizedText(text= 'InsertHistory', locale= None),LocalizedText(text= 'ModifyHistory', locale= None),LocalizedText(text= 'DeleteHistory', locale= None),LocalizedText(text= 'ReceiveEvents', locale= None),LocalizedText(text= 'Call', locale= None),LocalizedText(text= 'AddReference', locale= None),LocalizedText(text= 'RemoveReference', locale= None),LocalizedText(text= 'DeleteNode', locale= None),LocalizedText(text= 'AddNode', locale= None)]
    attrs.ValueRank = 1
    node.NodeAttributes = attrs
    await server.add_nodes([node])
    refs = []
    ...
    attrs.DisplayName = LocalizedText("OptionSetValues")
    attrs.DataType = ua.NodeId(ua.ObjectIds.LocalizedText)
    attrs.Value = [LocalizedText(text= 'CurrentRead', locale= None),LocalizedText(text= 'CurrentWrite', locale= None),LocalizedText(text= 'HistoryRead', locale= None),LocalizedText(text= 'Reserved', locale= None),LocalizedText(text= 'HistoryWrite', locale= None),LocalizedText(text= 'StatusWrite', locale= None),LocalizedText(text= 'TimestampWrite', locale= None)]
    attrs.ValueRank = 1
    node.NodeAttributes = attrs
    await server.add_nodes([node])
    refs = []
    ...
    attrs.DisplayName = LocalizedText("OptionSetValues")
    attrs.DataType = ua.NodeId(ua.ObjectIds.LocalizedText)
    attrs.Value = [LocalizedText(text= 'CurrentRead', locale= None),LocalizedText(text= 'CurrentWrite', locale= None),LocalizedText(text= 'HistoryRead', locale= None),LocalizedText(text= 'Reserved', locale= None),LocalizedText(text= 'HistoryWrite', locale= None),LocalizedText(text= 'StatusWrite', locale= None),LocalizedText(text= 'TimestampWrite', locale= None),LocalizedText(text= 'Reserved', locale= None),LocalizedText(text= 'NonatomicRead', locale= None),LocalizedText(text= 'NonatomicWrite', locale= None),LocalizedText(text= 'WriteFullArrayOnly', locale= None)]
    attrs.ValueRank = 1
    node.NodeAttributes = attrs
    await server.add_nodes([node])
    refs = []
    ...
    attrs.DisplayName = LocalizedText("OptionSetValues")
    attrs.DataType = ua.NodeId(ua.ObjectIds.LocalizedText)
    attrs.Value = [LocalizedText(text= 'SubscribeToEvents', locale= None),LocalizedText(text= 'Reserved', locale= None),LocalizedText(text= 'HistoryRead', locale= None),LocalizedText(text= 'HistoryWrite', locale= None)]
    attrs.ValueRank = 1
    node.NodeAttributes = attrs
    await server.add_nodes([node])
    refs = []
    ...
    attrs.DisplayName = LocalizedText("OptionSetValues")
    attrs.DataType = ua.NodeId(ua.ObjectIds.LocalizedText)
    attrs.Value = [LocalizedText(text= 'SigningRequired', locale= None),LocalizedText(text= 'EncryptionRequired', locale= None),LocalizedText(text= 'SessionRequired', locale= None)]
    attrs.ValueRank = 1
    node.NodeAttributes = attrs
    await server.add_nodes([node])
    refs = []
    ...
    attrs.DisplayName = LocalizedText("EnumStrings")
    attrs.DataType = ua.NodeId(ua.ObjectIds.LocalizedText)
    attrs.Value = [LocalizedText(text= 'Structure', locale= None),LocalizedText(text= 'StructureWithOptionalFields', locale= None),LocalizedText(text= 'Union', locale= None)]
    attrs.ValueRank = 1
    node.NodeAttributes = attrs
    await server.add_nodes([node])
    refs = []
