...
File creation Date:2021-01-25 14:16:37.907566
"""
import datetime
...
def create_standard_address_space_Part3(server):
    ...
    attrs.DisplayName = LocalizedText("OptionSetValues")
    attrs.DataType = ua.NodeId(ua.ObjectIds.LocalizedText)
    attrs.Value = [LocalizedText('SigningRequired'), LocalizedText('EncryptionRequired'), LocalizedText('SessionRequired'), LocalizedText('ApplyRestrictionsToBrowse')]
    attrs.ValueRank = 1
    attrs.ArrayDimensions = [0]
    node.NodeAttributes = attrs
    server.add_nodes([node])
