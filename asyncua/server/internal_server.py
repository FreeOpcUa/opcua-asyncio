...
class InternalServer:
    ...
    async def start(self):
        ...
        await Node(self.isession, ua.NodeId(ua.ObjectIds.Server_ServerStatus_State)).write(0, ua.VariantType.Int32)
        await Node(self.isession, ua.NodeId(ua.ObjectIds.Server_ServerStatus_StartTime)).write(datetime.utcnow())
    ...
    def _set_current_time(self):
        self.loop.create_task(self.current_time_node.write(datetime.utcnow()))
