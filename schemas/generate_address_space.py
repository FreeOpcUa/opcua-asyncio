...
Model Uri:{model.attrib["ModelUri"]}
Version:{model.attrib["Version"]}
Publication date:{model.attrib["PublicationDate"]}
...
def save_aspace_to_disk():
    path = os.path.join(BASE_DIR, 'asyncua', 'binary_address_space.pickle')
